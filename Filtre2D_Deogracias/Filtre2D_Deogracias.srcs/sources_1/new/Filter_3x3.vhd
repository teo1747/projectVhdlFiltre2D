...
signal Stage5sum : STD_LOGIC_VECTOR(7 downto 0):= "00000000";

signal Stage1sum_0, Stage2sum_0 , Stage3sum_0 : STD_LOGIC_VECTOR(7 downto 0):= "00000000";
...
--               dout <= "00000000";  
          ...
          Stage2sum_0 <= Stage1sum_0;
         
          Stage3sum <= (('0' & Stage2sum_1)  +  ('0' & Stage2sum_2));
          Stage3sum_0 <= Stage2sum_0;
